...
import { COMMON_MODE_MAP_DEFAULT, matchCommonMode } from './defines.js'
import { Converter } from './converter.js'
import { Mcp23Base } from './mcp23base.js'

/**
 * Adding Cache support for mode.
 **/
export class Mcp23Cached extends Mcp23Base {
	#commonMode

	constructor(bus: I2CAddressedTransactionBus, options) {
		super(bus, options)

		this.#commonMode = COMMON_MODE_MAP_DEFAULT
		// todo _iocon ?
	}
