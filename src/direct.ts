...
export class CommonDirect {
	...
	static async getDirection(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<Direction>> {
	...
	static async setDirection(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<Direction>) {
		const buffer = Converter.encodeDirection(value)
		return aBus.writeI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].IODIR, buffer)
	}

	static async getPolarity(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<EnabledInversePolarity>> {
	...
	static async setPolarity(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<EnabledInversePolarity>) {
		const buffer = Converter.encodePolarity(value)
		return aBus.writeI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].IPOL, buffer)
	}

	static async getInterrupt(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<EnabledInterrupt>> {
	...
	static async setInterrupt(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<EnabledInterrupt>) {
	...
	static async getDefaultValue(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<Digital>> {
	...
	static async setDefaultValue(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<Digital>) {
		const buffer = Converter.encodeDigit(value)
		return aBus.writeI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].IPOL, buffer)
	}

	static async getInterruptControl(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<InterruptControl>> {
	...
	static async setInterruptControl(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<InterruptControl>) {
	...
	static async getPullUp(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<PullUp>> {
	...
	static async setPullUp(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<PullUp>) {
		const buffer = Converter.encodePullUp(value)
		return aBus.writeI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].GPPU, buffer)
	}

	static async getInterruptFlag(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<InterruptFlag>> {
	...
	static async getInterruptCaptureValue(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<Digital>> {
		const buffer = await aBus.readI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].INTCAP, BYTE_LENGTH_ONE)
		return Converter.decodeDigit(buffer)
	}

	static async getOutputValue(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<Digital>> {
		const buffer = await aBus.readI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].GPIO, BYTE_LENGTH_ONE)
		return Converter.decodeDigit(buffer)
	}

	static async setOutputValue(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<Digital>) {
		const buffer = Converter.encodeDigit(value)
		return aBus.writeI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].GPIO, buffer)
	}

	static async getOutputLatchValue(aBus: I2CAddressedBus, mode: Mode, port: Port): Promise<Iterable<Digital>> {
		const buffer = await aBus.readI2cBlock(REGISTERS_BY_BANK_PORT[mode.bank][port].OLAT, BYTE_LENGTH_ONE)
		return Converter.decodeDigit(buffer)
	}

	static async setOutputLatchValue(aBus: I2CAddressedBus, mode: Mode, port: Port, value: Iterable<Digital>) {
		const buffer = Converter.encodeDigit(value)
